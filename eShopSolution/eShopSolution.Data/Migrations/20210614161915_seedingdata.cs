    ...
    public partial class seedingdata : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<DateTime>(
                ...
                type: "datetime2",
                nullable: false,
                defaultValue: new DateTime(2021, 6, 14, 23, 19, 14, 562, DateTimeKind.Local).AddTicks(3181),
                oldClrType: typeof(DateTime),
                oldType: "datetime2",
                oldDefaultValue: new DateTime(2021, 6, 12, 16, 59, 46, 353, DateTimeKind.Local).AddTicks(8563));
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "IsShownOnHome", "ParentId", "SortOrder" },
                values: new object[,]
                {
                    { 1, true, null, 1 },
                    { 2, true, null, 2 }
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 6, 14, 23, 19, 14, 582, DateTimeKind.Local).AddTicks(695), 100000m, 200000m });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<DateTime>(
                ...
                type: "datetime2",
                nullable: false,
                defaultValue: new DateTime(2021, 6, 12, 16, 59, 46, 353, DateTimeKind.Local).AddTicks(8563),
                oldClrType: typeof(DateTime),
                oldType: "datetime2",
                oldDefaultValue: new DateTime(2021, 6, 14, 23, 19, 14, 562, DateTimeKind.Local).AddTicks(3181));
        }
    }
}
